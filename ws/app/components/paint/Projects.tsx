...
function ProjectItem({ title, description, tags, githubUrl, liveUrl, year, index }: ProjectProps & { index: number }) {
  return (
    <div className="py-6 md:py-8 border-b border-[#948ab8] last:border-b-0 group">
      <div className="flex flex-col md:flex-row items-start gap-4 md:gap-8">
        {/* Number/Index */}
        <div className="text-2xl md:text-4xl font-bold text-gray-300 group-hover:text-[#948ab8] transition-colors w-auto md:w-16 flex-shrink-0">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-4 mb-2 md:mb-3">
            ...
            {year && <span className="text-xs md:text-sm text-gray-500">{year}</span>}
          </div>
          
          {/* Description */}
          <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-lg leading-relaxed max-w-3xl">{description}</p>
            ...
            <div className="flex gap-4 items-center">
              ...
              {liveUrl && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 hover:text-[#7092be] transition-colors underline text-xs md:text-sm"
                >
...
export function Projects() {
  return (
    <div className="flex-1 overflow-auto">
      <div className="max-w-6xl mx-auto px-4 py-8 md:px-8 md:py-20">
        {/* Header */}
        <div className="mb-8 md:mb-16">
        <div className="flex items-center gap-3 md:gap-4">
            <h1 className="text-4xl md:text-7xl font-bold mb-2 md:mb-4" style={{ color: "#7092be" }}>
              projects
            </h1>
            <img src="/icons/flowers.png" alt="letter" className="w-12 h-11 md:w-20 md:h-18 ml-1 md:ml-4 -rotate-10 object-cover hover:-rotate-20 transition-all duration-100"/>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="mt-10 md:mt-16 pt-6 md:pt-8 border-t border-[#948ab8]">
          <a 
