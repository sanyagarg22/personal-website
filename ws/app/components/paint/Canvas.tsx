...
export function Home(){
  return (
    <div className="absolute top-1/5 left-2 pointer-events-none p-2 md:top-1/4 md:left-1/16 md:p-4">

    <div className="text-4xl md:text-7xl font-bold pointer-events-none">
        <div className="relative inline-block">
          <img
            src="/icons/sanya_cursive.png"
            alt="sanya garg"
            className="w-64 h-24 ml-7 object-cover md:ml-0 md:w-120 md:h-40 md:ml-8"
          />
          <div
            className="w-8 h-8 md:w-12 md:h-12 bg-cover bg-center absolute top-0 -right-8 md:-right-16 bg-[url('/icons/star.png')] hover:rotate-20 transition-all duration-300 pointer-events-auto"
            style={{ backgroundImage: "url('/icons/star.png')" }}
          />
          <img
            src="/icons/strawberry.png"
            alt="strawberry"
            className="w-6.5 h-8 ml-3 md:ml-0 md:w-11 md:h-12 object-cover absolute bottom-2 md:bottom-5 left-0 hover:-rotate-20 transition-all duration-300 pointer-events-auto -translate-x-1/2 translate-y-1/4"
          />
        </div>
      </div>
        <div className="text-gray-600 text-sm md:text-xl mt-2 pointer-events-none max-w-[90vw] md:max-w-none">
          welcome to my personal website inspired by the legacy microsoft paint app!
        </div>
        <div className="hidden md:block text-gray-600 text-sm md:text-xl mt-2 pointer-events-none max-w-[90vw] md:max-w-none" style={{ color: "#7092be" }}>
           feel free to make a doodle or two while you're here :)
        </div>
        <div className="block md:hidden text-gray-600 text-sm md:text-xl mt-2 pointer-events-none max-w-[90vw] md:max-w-none" style={{ color: "#7092be" }}>
           give this a visit on desktop to try making a doodle or two :)
        </div>
        <Icons />
    </div>
  )
...
export function Icons(){
  return (
    <div className="flex items-center gap-3 md:gap-4 mt-4 md:mt-6 pointer-events-auto z-10">
      <a 
        href="https://www.linkedin.com/in/sanya-garg/" 
        target="_blank" 
        className="w-7 h-7 md:w-8 md:h-8 flex items-center justify-center hover:opacity-70 transition-opacity text-gray-600"
        title="LinkedIn"
      >
